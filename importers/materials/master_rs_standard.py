...
from .nodes import cast_shadows, constant_buffer_value, dx_to_gl_normal, grid_location, if_nz, texture_sampler

def master_rs_standard(textures_dir: str, material: bpy.types.Material, instance: tpGxMaterialInstanceV2):
    # Renamed in 5.0
