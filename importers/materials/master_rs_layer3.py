...
def master_rs_layer3(textures_dir: str, material: bpy.types.Material, asset: Asset):
    # Renamed in 5.0
    ...
    # gUVOffset3
    g_uv_offset_3 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVOffset3")
    ...
    # gUVScale3
    g_uv_scale_3 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVScale3")
    ...
    # gUVOffset0
    g_uv_offset_0 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVOffset0")
    ...
    # gUVScale0
    g_uv_scale_0 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVScale0")
    ...
    # gUVOffset1
    g_uv_offset_1 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVOffset1")
    ...
    # gUVScale1
    g_uv_scale_1 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVScale1")
    ...
    # gUVOffset2
    g_uv_offset_2 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVOffset2")
    ...
    # gUVScale2
    g_uv_scale_2 = constant_buffer_value(material, nodes, asset, "CbLayer3", "gUVScale2")
