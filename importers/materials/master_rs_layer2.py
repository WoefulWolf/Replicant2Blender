...
def master_rs_layer2(textures_dir: str, material: bpy.types.Material, asset: Asset):
    # Renamed in 5.0
    ...
    # gUVOffset2
    g_uv_offset_2 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVOffset2")
    ...
    # gUVScale2
    g_uv_scale_2 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVScale2")
    ...
    # gUVOffset0
    g_uv_offset_0 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVOffset0")
    ...
    # gUVScale0
    g_uv_scale_0 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVScale0")
    ...
    # gUVOffset1
    g_uv_offset_1 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVOffset1")
    ...
    # gUVScale1
    g_uv_scale_1 = constant_buffer_value(material, nodes, asset, "CbLayer2", "gUVScale1")
